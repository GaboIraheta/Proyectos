...
@Component
public class NearestExitStrategy implements LocationAssignmentStrategy {

    @Override
    public AssignmentStrategy strategyName() {
        return AssignmentStrategy.NEAREST_EXIT;
    }
    ...
    public StorageLocation assign(List<StorageLocation> availableLocations, StorageRequirement requirement) {
        ...
        return availableLocations.stream()
                .min(Comparator.comparingInt(StorageLocation::getCurrentOccupancy))
