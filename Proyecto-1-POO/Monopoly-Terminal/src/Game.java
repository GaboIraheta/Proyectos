...
import Casualidades.Builders.BuilderCasualidad;
import Casualidades.Builders.BuilderCasualidadImpuestoCasas;
...
public class Game {
    ...
    public static void playGame() throws IOException {
        ...
        /* bucle que contiene todas las acciones del juego
         * el cual se rompe unicamente si un jugador cae en bancarrota
         */
        while (true){
            for (Jugador jugador : tablero.getJugadores()){
                tablero.turno(jugador);
                if (jugador.bancarrota()){
                    System.out.println(jugador.getNombre() + " ha quedado en bancarrota!\n El juego ha terminado.");
                    return;
                }
                ((Carcel) tablero.getCasillas().get(10)).checkPresos(jugador);
